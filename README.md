...
This project hacked the [RPi-Web-Cam-Interface](https://elinux.org/RPi-Cam-Web-Interface) a bit. The mjpeg was used to show the circular images on one html page (panoindex.php, cam_slave_pic.php and cam_slave_pic_new.php) and take the photo via html request.  
...
4. Change some image settings, such as resolutions to Max View, turn off the **exposure mode** and **white ballance**, rotate the image if necessary.
